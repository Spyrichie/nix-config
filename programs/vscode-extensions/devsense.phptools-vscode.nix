# Copied from
# https://github.com/NixOS/nixpkgs/blob/48f4c982de68d966421d2b6f1ddbeb6227cc5ceb/pkgs/applications/editors/vscode/extensions/default.nix#L1401
# since the file was removed from unstable.
